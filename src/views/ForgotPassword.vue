...
const handleResetPassword = async () => {
  ...
  try {
    ...
    if (data.code === 200) {
      ...
      showToast(data.message || '重置失败，请检查填写内容', 'error')
    }
  } catch (error) {
  ...
  <div class="forgot-password-page">
    ...
    <main class="forgot-content">
      <div class="welcome-section">
        ...
        <p class="welcome-subtitle">验证您的邮箱以重置账号密码</p>
      </div>
      ...
      <div class="form-container">
        <div class="reset-form">
          ...
          <div class="input-group">
            <label for="email" class="input-label">注册邮箱</label>
          ...
          <!-- New Password Field -->
          <div class="input-group">
            <label for="newPassword" class="input-label">设置新密码</label>
            <div class="input-wrapper">
              <span class="input-icon">🔒</span>
              <input 
                type="password" 
          ...
          <div class="input-group">
            ...
            <div class="input-wrapper">
              ...
              <input 
                ...
                class="form-input"
                :class="{ 'error-border': confirmPassword && newPassword !== confirmPassword }"
              />
            </div>
            <p v-if="confirmPassword && newPassword !== confirmPassword" class="error-text">密码不一致</p>
          </div>

          <button class="reset-btn" @click="handleResetPassword" :disabled="!isFormValid">
            重置密码
          </button>
        </div>
      </div>
